...
/*
 * This file is part of mac_stubs.
 *
 ...
 *
 * <p>General note on error handling: all routines exported by mac_stubs  set
 ...
 * translates the kernel representation of the event to the mac_stubs format.
 */
 ...
 * @{
 *
 * Various mac_stubs-related functions.
 */
